...
const Checkbox = __webpack_require__(/*! ./components/Checkbox.jsx */ "./src/components/Checkbox.jsx");

const CHECKLISTOPTIONS = [["Clear add to cart button", 10], ["Testimonials / Reviews", 10], ["Trust Icons", 10], ["Show low shipping costs", 10], ["Add guest checkout option", 10], ["Keep required information to a minimum", 10], ["Minimal Distractions", 10], ["Increase number of payment options", 10], ["Reduce spammy looking sale tactics", 10]];
...
class ChecklistForm extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      checkboxes: CHECKLISTOPTIONS.reduce((options, option) => _extends({}, options, {
        [option[0]]: false
      }), {}),
      score: 0
    };
    ...
    this.selectAllCheckboxes = isSelected => {
      Object.keys(this.state.checkboxes).forEach(checkbox => {
        this.setState(prevState => ({
          checkboxes: _extends({}, prevState.checkboxes, {
            [checkbox]: isSelected
          })
        }));
      });
    ...
    this.createCheckboxes = () => CHECKLISTOPTIONS.map((option, index) => {
  ...
  render() {
    return React.createElement(
      "form",
      { style: { width: "300px" }, onSubmit: this.onDoneClick },
      React.createElement(
        "header",
        null,
        React.createElement(
      ...
      React.createElement(
        "p",
        null,
        "Check off items from the list that are included in your prototype to see your current conversion score."
      ),
      React.createElement(
        "div",
        null,
...
const App = __webpack_require__(/*! ./ChecklistForm.jsx */ "./src/ChecklistForm.jsx");
